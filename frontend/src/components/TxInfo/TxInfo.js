    ...
    if(mobile){
        ...
        if(create){
            txInfo = (
                <div className={classes.TxMessage}>
                    ...
                    <p><a target="_blank" href={`https://explorer-mumbai.maticvigil.com/tx/${sentTx}`}>View transaction here</a></p>
        ...
        txInfo = (
            <div className={classes.TxMessage}>
                ...
                <p><a target="_blank" href={`https://explorer-mumbai.maticvigil.com/tx/${txBeingSent}`}>{txBeingSent}</a></p>
            </div>
        )
    } else if(!address){
        txInfo = (
